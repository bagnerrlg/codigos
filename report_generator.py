    ...
    <script>
        (function() {
            ...
            function render(fo, fc, ffb, tv, tg, start, end) {
                ...
                ], { ...layout, yaxis: { title: "Cant. Leads" }, yaxis2: { title: "Dinero (Q)", overlaying: "y", side: "right" } }, config);
            }
            init();
        })();
    </script>
