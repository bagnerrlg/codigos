...
<script>
    ...
    function loadWhatsAppNumbers() {
      ...
      wa.innerHTML = '<option value="">Seleccione número...</option>' +
        '<option value="'+document.getElementById('wa1').value+'">WhatsApp 1</option>' +
        '<option value="'+document.getElementById('wa2').value+'">WhatsApp 2</option>' +
        '<option value="'+document.getElementById('wa3').value+'">WhatsApp 3</option>' +
        '<option value="'+document.getElementById('wa4').value+'">WhatsApp 4</option>' +
        '<option value="'+document.getElementById('wa5').value+'">WhatsApp 5</option>';
    }
